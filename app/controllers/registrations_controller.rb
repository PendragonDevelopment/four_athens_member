	  ...
	  if resource.save
		  ...
		  if @subscription.save
		  	...
		  	if resource.save
		  		...
		  		flash[:notice] = "There was an error with subscription. Please contact the administrator: Jim Flannery jim@fourathens.com"
		  	end
  	  else
  	    resource.role = "locked"
  	  	resource.save
  	  	flash[:notice] = "The subscription was unsuccessful. Please contact the administrator: Jim Flannery jim@fourathens.com"
  	  end
	  end
  end
